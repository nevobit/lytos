...
// same helpers as portal app; keep in sync if you change
...
const Roles = () => {
    ...
    const addRole = () => {
        setLocal([
            ...local,
            { workspaceId: '', name: '', description: '', permissions: [], scopes: {} as unknown, isSystem: false } as Partial<Role>,
        ]);
    };
                        ...
                        <details key={p.id ?? `new-${idx}`} className={styles.accordionItem}>
                            ...
                            <div className={styles.accordionBody}>
                                ...
                                <div>
                                    ...
                                    {p.permissionEntries?.map((entry, peIdx) => (
