import { authorizePermission, getAllTicketPriorities } from "@lytos/business-logic";
...
export const listTicketPrioritiesRoute = makeFastifyRoute(
    RouteMethod.GET,
    "/",
    verifyJwt,
    ...
    async (req, reply) => {
        ...
        await authorizePermission({ workspaceId: wsId, roleId, permission: "ticket-priorities.read" });

        const out = await getAllTicketPriorities({ ...params, workspaceId: wsId });
