...
import { authorizePermission, getAllTicketStatuses } from "@lytos/business-logic";

export const listTicketStatusesRoute = makeFastifyRoute(
    RouteMethod.GET,
    "/",
    verifyJwt,
    ...
    async (req, reply) => {
        ...
        try {
            const out = await getAllTicketStatuses(params);
