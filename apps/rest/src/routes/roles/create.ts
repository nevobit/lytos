...
import { authorizePermission, createRole } from "@lytos/business-logic";
import type { CreateRoleDto } from "@lytos/contracts";
...
export const createRoleRoute = makeFastifyRoute(
    ...
    async (req, reply) => {
        ...
        try {
            ...
            const created = await createRole(workspaceId, dto);
