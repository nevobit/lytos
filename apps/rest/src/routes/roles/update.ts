...
import { authorizePermission, updateRole } from "@lytos/business-logic";
import type { UpdateRoleDto } from "@lytos/contracts";
...
export const updateRoleRoute = makeFastifyRoute(
    ...
    async (req, reply) => {
        ...
        try {
            ...
            const updated = await updateRole(workspaceId, id, dto);
